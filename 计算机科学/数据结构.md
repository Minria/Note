...
![Snipaste_2022-01-05_17-25-09](..\picture\ds\202201111632015.png)
...
当删除节点有右孩子的时候，让右孩子接替位置

当删除节点有左孩子的时候，让左孩子接替位置
...
祖父节点是否存在？存在，如果不存在那么父亲节点为黑色。并且祖父节点为黑色

叔叔节点是否存在？不确定，需要分类讨论

![202203262030](../picture/ds/202203262030.png)
